...
?>
		...
		<div class="page-container">
			<div class="sub-container cookies">
				<h1>Informativa estesa sui Cookie</h1>

				<p>
					I Cookie sono costituiti da porzioni di codice installate all'interno del browser che assistono il Titolare nell’erogazione
					del servizio in base alle finalità descritte. Alcune delle finalità di installazione dei Cookie potrebbero, inoltre,
				...
				<p>
					Alcuni dei servizi elencati di seguito raccolgono statistiche in forma aggregata e potrebbero non richiedere il consenso dell'Utente o potrebbero
					essere gestiti direttamente dal Titolare – a seconda di quanto descritto – senza l'ausilio di terzi.
					<br>
					...
					ed anche all’insaputa del Titolare – compiere attività di tracciamento dell’Utente. Per informazioni dettagliate in merito, si consiglia di
				...
				<p>
					...
					<br>
					Nel caso in cui sia installato un servizio di interazione con i social network, è possibile che, anche nel caso gli Utenti non utilizzino il servizio,
					lo stesso raccolga dati di traffico relativi alle pagine in cui è installato.
				</p>
				<p>
					<u>Pulsante +1 e widget sociali di Google+ (Google Inc.)</u>
					<br>
				...
				<p>
					...
					<br>
					<br>
					<u>Pulsante Tweet e widget sociali di Twitter (Twitter, Inc.)</u>
					<br>
				...
				<p>
					...
					<br>
					<br>
					<u>Facebook Remarketing (Facebook, Inc.)</u>
					<br>
					...
					<br>
					Luogo del trattamento : USA – <a href="https://www.facebook.com/about/privacy/" target="_blank">Privacy Policy</a> – <a href="http://www.aboutads.info/choices/" target="_blank">Opt Out</a>
				</p>
				...
				<p>
					...
					<br>
					<br>
					<u>Google Analytics (Google Inc.)</u>
					<br>
					...
					Dati personali raccolti: Cookie e Dati di utilizzo.
					<br>
					Luogo del trattamento: USA – <a href="http://www.google.com/intl/it/policies/privacy/" target="_blank">Privacy Policy</a> – <a href="http://tools.google.com/dlpage/gaoptout?hl=it" onclick="javascript:return tryFunc('tryGaOptOut',{href:'http://tools.google.com/dlpage/gaoptout?hl=it'})" target="_blank">Opt Out</a>
				</p>
				...
				<p>
					...
					<br>
					<br>
					<u>Widget Video Youtube (Google Inc.)</u>
					<br>
					Youtube è un servizio di visualizzazione di contenuti video gestito da Google Inc. che permette a questa Applicazione di integrare tali contenuti all’interno delle proprie pagine.
					<br>
					Dati personali raccolti: Cookie e Dati di utilizzo.
					<br>
					Luogo del trattamento : USA – <a href="http://www.google.it/intl/it/policies/privacy/" target="_blank">Privacy Policy</a>
				</p>
				...
				<p>
					...
					<br>
					Via G. Nisio, 80 - 00135 Roma (Italia),
					<br>
					omegaiori@gmail.com
					<br>
					<br>
